...
STRANDS = [
    ...
    ("architecture","Architecture & monuments","Matter & the senses"),
    ("scent","Scent & perfume","Matter & the senses"),
    ("fashion","Fashion & textile","Matter & the senses"),
    ("food","Food & gastronomy","Matter & the senses"),
    ("merch","Merchandise & ephemera","Matter & the senses"),
